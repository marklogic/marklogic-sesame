...
class MarkLogicBackgroundTupleResult extends BackgroundTupleResult {
            ...
            throws QueryEvaluationException
    {
        try {
            ...
            logger.info("MarkLogicBackgroundTupleResult hasNext() stream closed exception",e);
            return false;
        }
    }
    ...
    protected void handleClose() throws QueryEvaluationException {
        try {
            ...
            logger.info("MarkLogicBackgroundTupleResult handleClose() stream closed exception",e);
        }
    }
}
